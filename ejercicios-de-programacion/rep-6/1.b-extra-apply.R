...
# f: función que suma la cantidad de NAs que tiene un vector cualquiera. No es
#    obligatorio crear f: la función puede ser definida en la misma línea en
#    que se ejecuta apply (buscar por "anonymous function" en la web)
