...
# Instrucciones: 
# El objetivo es crear un gráfico con dos histogramas, uno encima del otro.
# Para determinar que sean dos gráficos en uno, debe utilizar la función 
...
hist.m <- 0 # hist.m es salida de la función hist

hist.h <- 0 # hist.h es salida de la función hist
