...
lo que ya está escrito). \textbf{Cuide siempre de no escribir ninguna
línea de código ajena a los propósitos del ejercicio mismo}. Por
ejemplo, debe tener cuidado de no dejar escritas líneas como
...
satisfactoria (ver también el documento
\href{http://eva.universidad.edu.uy/file.php/1454/ejercicios\_de\_programacion/dinamica-reps.pdf}{Dinámica
de trabajo de los repartidos}).
