...
# Instrucciones:
# Modifique el código de abajo para obtener una función que calcule el
# índice de Shannon-Wiener de cualquier vector numérico como entrada/input.
# Recuerde que dicho vector debe figurar como argumento de la función.

# Los objetos internos de la función siguen la ecuación 1 de la letra del repartido:
