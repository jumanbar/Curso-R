...
describen a continuación. Luego de terminar cada ejercicio usted podrá
verificar rápidamente si su respuesta es correcta ejecutando el comando:
...
\texttt{verNotas()}. Una vez terminados los ejercicios del repartido, usted
deberá subir el archivo "datos" (sin extensión), incluido en la carpeta "rep-1",
...
Además usted debe encontrar el entero \texttt{n} mínimo necesario para
lograr un valor de \texttt{out} muy cercano a 1. Específicamente, la
diferencia entre \texttt{out} y 1 debe ser menor a 0.000001 (i.e.:
1e-06). Puede comprobar que su resultado cumple con esa premisa con el
comando \texttt{1 - out \textless{} 1e-06}. El valor de \texttt{n}
encontrado debe ser el generado en el archivo ``zenon.R''.
...
tales que $1 > \|z\|$ (valor absoluto de $z$). El objetivo de este
