...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{x %in%}\StringTok{ }\NormalTok{y}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{a <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"ta"}\NormalTok{, }\StringTok{"te"}\NormalTok{, }\StringTok{"ti"}\NormalTok{)}
\NormalTok{b <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"ta"}\NormalTok{, }\StringTok{"ti"}\NormalTok{)}
\NormalTok{a %in%}\StringTok{ }\NormalTok{b}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{>}\StringTok{ }\KeywordTok{tabulate}\NormalTok{(usa3$Ing.Cat)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{levels}\NormalTok{(usa3$Ing.Cat) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"D"}\NormalTok{, }\StringTok{"C"}\NormalTok{, }\StringTok{"B"}\NormalTok{, }\StringTok{"A"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
