# Instrucciones: exportar la data.frame usaNorm en un archivo llamado 
# "usa-norm.csv" siguiendo los criterios indicados en la letra del repartido. 
# El código generado aquí debe partir de una data.frame llamada 'usaNorm' y debe 
