# Una vez cargado este archivo con source, ejecute "plotTriang()" para 
# obtener el triángulo de la figura 2 del repartido.
# Modifique este archivo a placer, no afecta a la corrección.
plotTriang <- function(print.coor = TRUE) {
  a <- c(2, 6)
  b <- c(2, 5)
