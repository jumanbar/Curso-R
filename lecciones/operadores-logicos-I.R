...
# Es un OR elemento a elemento pero resulta en un FALSE por cada TRUE
# compartido (en la misma posición).
# Ejemplo:
x <- -5:5
x > 0
x < 3
# Se puede ver que en ambas comparaciones los elementos 7 y 8 son TRUE
# Precisamente es en estos casos ("intersecciones") que xor da negativo (FALSE) 
xor(x > 0, x < 3)
