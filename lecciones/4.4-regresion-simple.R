...
# Para finalizar queremos aclarar que la idea de etse curso no es enseñar estadística, para eso existen un montón de cursos sobre la materia dictada por docentes entendidos sobre el tema. Sin embargo, R es un software para realizar análsis estadśiticos, por ese motivo no queríamos dejar de lado las interpretaciones mínimas de los análsis que pretendemos mostrar. Para mayor profundidad existie una gran diversidad de libros sobre R y Estadística, los cuales estan a su disposición por parte nuestra si así lo desan.