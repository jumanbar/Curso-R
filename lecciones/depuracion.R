...
## Para hacer más fácil este ejemplo, se incluyen aquí las líneas necesarias para
## definir la función "estimaPi" en nuestra área de trabajo:
...
## Traceback muestra qué funciones estaban corriendo en el momento en que ocurrió
## el error; en este caso muestra dos funciones, ya que están anidadas. No todas
## las funciones son registradas por este algoritmo: sqrt, abs, y otras (ver
## ?Special) son ejemplos (en general funciones relacionadas con matemática básica).
...
## un "#" al principio de la misma (Ctrl+/ en RStudio), de forma ahora no se
## ejecuta el comando:
# n <- n + 1
...
## MÉTODO 1: IMPRIMIR
## La forma más sencilla de averiguar qué ocurre, es usando la función print para
## que estimaPi nos vaya mostrando un objeto que nos parezca importante.
## Por ejemplo, es crucial que dif vaya disminuyendo a medida que se repiten
## las iteraciones de estimaPi, por lo que vamos a agregar una línea, luego de la 
## línea 20, en la que pondremos "print(dif)". Salvamos y cargamos de nuevo.
...
## Los objetos que sólo existen dentro de la función ahora se pueden ver, de forma
## podemos buscar los errores, mirando las diferencias entre lo que valen y lo
## que deberían valer.
## Dentro de esta modalidad, hay ciertos comandos especiales, los cuales se pueden
## ver en la ayuda de browser().
?browser
...
## MÉTODO 3: BROWSER
## El método más sofisticado que vamos a ver es la combinación de un condicional,
## if con la función browser.
