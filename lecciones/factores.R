...
# Los objetos "factor" son objetos que sirven para trabajar con variables
# categóricas, como pueden ser franjas etareas, nombres de especies o
# lugares. Una forma de comprender el concepto de factor es pensando en su
# uso dentro del diseño experimental: un factor es una variable cuyo efecto
# se busca entender; en un experimento se crean distintos tratamientos,
# cada uno con un nivel determinado para dicho factor.
...
# Una variable numérica puede ser categorizada en un factor, usando la
# función "cut". Por ejemplo, si asumimos que "edades" es un muestreo de
# edades de estudiantes de la universidad:
edades <- rpois(150, 25)

# Podemos crear un factor de n categorías:
...
# relacionados con estadística y trabajo con datos.
