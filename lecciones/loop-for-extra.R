...
# necesita de esta demarcación, pero si hay más de uno sí es imperativo usarla.
...
# Nota: la llamada vectorización generalmente veces no puede ser implementada en
# loops while.
...
# Sin embargo esto puede ser fácilmente unas 600 veces más lento que simplemente
# escribir:
l <- m + n
...
# cambio las variantes de apply, como lapply, pueden aumentar la velocidad de un
# código notoriamente.
