...
# valor central de un conjunto de datos, el valor "del medio", en donde
# podemos encontrar el 50% de nuestros datos a cada lado de este valor. En una
# distribución Normal o Gaussiana, la mediana va a presentar un valor muy
# similar al de la media (promedio). Presenta, sin embargo, algunas
# características que lo hacen particularmente útil al trabajar con datos. Por
# ejemplo es poco sensible a la presencia en nuestro conjunto de datos de
# valores extremos, por fuera de lo esperado.
...
# en este caso se le esta marcando con el argumento 'prob' el valor del
# cuantil que quiero obtener.
...
# valo de valores está una determinada cantidad de nuestras observaciones.
# Así, si queremos saber entre qué valores encontramos el 95% de nuestros
# datos, sólo tenemos que "recortar" a los datos 2.5% en cada extremo, o sea,
# los percentiles 2.5 y 97.5-
quantile (vec, prob = c(0.025, 0.975))
# Si queremos los intervalos de confianza al 99%, sacamos 0.5% en cada extremo
