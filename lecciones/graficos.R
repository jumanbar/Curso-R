...
# mar=c(bottom, left, top, right) // margin
# oma=c(bottom, left, top, right) // outer margin
# mfcol, mfrow // "matrix figure"
...
fish  <- read.csv("fishharvest.csv") # leer los datos (suponiendo que están en el directorio correcto)
