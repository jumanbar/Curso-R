#### Coercionadores & Identificadores
...
# Estas funciones, si pueden, "Coercionan" el objeto de entrada, generando
# un objeto de salida de la clase deseada.

# El nombre de estas funciones sigue la pauta: "as.clase", en donde la
# palabra "clase" debe ser sustituida por una clase existente...
...
# También debe tenerse en cuenta que no todas las clases pueden
# Coercionarse como queremos.
...
x <- 1:5
is.numeric(x)
# Nótese que a pesar de que "x" es "integer", el resultado es TRUE
...
# Resumen:
# Los Coercionadores son funciones de gran utilidad cuando necesitamos
