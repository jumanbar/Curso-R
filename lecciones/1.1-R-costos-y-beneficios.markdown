...
![**Figura 2**. Ejemplo de un diálogo humano. R, o una computadora en general, pasaría un mal rato descifrando el significado de las palabras "briyantina" o "güenazo"](files/inodoro.jpg "Autor: Roberto Fontanarrosa")
