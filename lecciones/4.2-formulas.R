...
w <- cbind(x, z)
y ~ w # es exactamente lo mismo que
y ~ x + z
...
# Normalmente la fórmula es incluida como el primer argumento de la función. 
# Por ejemplo, para hacer una regresión lineal entre el largo de sépalo y ancho de sépalo de la especie setosa, incluida en la tabla "iris":
