...
## los programas propios, si se aplican regularmente. A saber:
...
## Las variables se escriben en minúscula y las palabras se separan mediante ## puntos(.).
...
## Las líneas dedicadas a comentarios (como esta) deben empezar con un '#' 
## (ouch!) y un espacio.
