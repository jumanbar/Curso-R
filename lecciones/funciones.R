...
alf <- function() print("¡No hay problema!")
alf() # Es una función con 1 sóla salida posible.
...
## es fundamental tener claro qué objetos están presentes en este ambiente
...
##    fue definida la función. En este caso no hay ningún ejemplo de
...
## escribiendo una función, la cual podremos reutilizar cuando la
## necesitemos, cambiando los argumentos.
...
## El archivo "estimaPi.R" es un script con 2 funciones incluidas.
